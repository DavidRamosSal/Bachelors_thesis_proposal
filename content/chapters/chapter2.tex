...
El radio de la estrella $R$ se define como el valor de $r$ en el que la presión se anula, esto es, $P(R)=0$ y de manera similar la masa de la estrella $M$ se define como el valor de la masa encerrada en $r=R$, esto es, $m(R)=M$.\REMARK{¿Debería poner de una vez la forma alternativa del sistema, en la que la variable independiente es $m$ (a la Lagrange)?}
